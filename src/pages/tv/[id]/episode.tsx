import { Detail, Episode, Season } from "../../../models/type";
import { Fragment, useState } from "react";
import { embedEpisode, imageOriginal } from "../../../api/constants";
                        ...
                        <Fragment key={item.season_number}>
                            ...
                            >
                                ...
                                <div className="flex flex-col justify-center items-start">
                                    <h1
                                        className={`text-lg transition ${opened === item.season_number ? "text-orange-500" : ""
                                            }`}
                                    >
                                        {item.name}
                                    </h1>
                                        ...
                                        >
                                            <a>
                                                <div className="flex items-center bg-dark-darken w-full rounded-lg overflow-hidden cursor-pointer hover:brightness-[80%] transition duration-300">
                                                    ...
                                                    <div className="flex-grow">
                                                        <p
                                                            className={`${child.episode_number === Number(episodeId)
                                                                ? "text-orange-500"
                                                                : ""
                                                                }`}
                                                        >
